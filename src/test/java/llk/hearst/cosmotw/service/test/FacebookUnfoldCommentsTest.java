...
public class FacebookUnfoldCommentsTest extends TestCase {
	...
	public void testCosmotwIoFBUnfold() throws Exception {
		...
		// ERROR: Caught exception [ERROR: Unsupported command [createCookie |
		// nsghtn=dev | ]]
		...
		// ERROR: Caught exception [ERROR: Unsupported command [getCookieByName
		// | nsghtn | ]]
		...
		wait.until(ExpectedConditions.textToBePresentInElementLocated(By.cssSelector("button.module-comments--toggle"),
				"隱藏留言"));
